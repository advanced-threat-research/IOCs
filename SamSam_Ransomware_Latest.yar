...
rule SamSam_Ransomware_Latest
{
   ...
   strings:
      ...
      $s6 = "81ee346489c272f456f2b17d96365c34" fullword wide
      ...
      $s11 = "f833797f05ea5e6cc99484083a609095" fullword wide
      ...
      $s15 = "94682debc6f156b7e90e0d6dc772734d" fullword wide
      $s16 = "b1c7e24b315ff9c73a9a89afac5286be" fullword wide
      $s17 = "90928fd1250435589cc0150849bc0cff" fullword wide
      $s18 = "67da807268764a7badc4904df351932e" fullword wide
      $s19 = "e954d19616e91ef6a4765e2acc6b24ea" fullword wide
      $s20 = "bc2381f03bb11b045a09d85ee63448c2" fullword wide
   condition:
      ( uint16(0) == 0x5a4d and
        filesize < 100KB and
